...
class cfgroup_repeater extends cfgroup_field
{
    ...
    */
    function html( $field ) {
        ...
        $this->recursive_html( $field->group_id, $field->id, '', 0, $field );
    }
    ...
    */
                ...
                <div class="fields-wrapper">
                    <?php foreach ( $results as $field ) : ?>
                        <div class="field-column-<?php echo $field->column_width; ?>">
                            ...
                            <div class="field field-<?php echo esc_attr( $field->name ); ?> cfgroup_<?php echo esc_attr( $field->type ); ?>">
                            <?php
    ...
    ================================================================
    */
    function recursive_html( $group_id, $field_id, $parent_tag = '', $parent_weight = 0, $repeater_field_obj = null ) {
                ...
                <?php foreach ( $results as $field ) : ?>
                    <div class="field-column-<?php echo $field->column_width; ?>">
                        ...
                        <?php if ( 'repeater' == $field->type ) : ?>
                            <?php $this->recursive_html( $group_id, $field->id, "{$parent_tag}[$i][$field->id]", $i, $field ); ?>
                        <?php else : ?>
                        <?php
                            $args = [
                                'type' => $field->type,
