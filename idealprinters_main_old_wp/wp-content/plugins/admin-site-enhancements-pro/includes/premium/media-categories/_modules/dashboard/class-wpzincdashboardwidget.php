...
class WPZincDashboardWidget {
	...
	/**
	 * Helper function to determine whether to load minified Javascript files or not.
	 *
	 * Media Categories no longer ships minified JS assets, so this always returns false.
	 *
	 * @since   1.0.0
	 *
	 * @return  bool    Load minified JS (always false).
	 */
	...
	public function add_action_link( $links, $file ) { // phpcs:ignore Generic.CodeAnalysis.UnusedFunctionParameter
		...
		// This is commented out since v7.2.1 to prevent conflict with WP to Buffer plugin
		// causing PHP Fatal error on the plugins list page
		// if ( $this->endpoint ) {
