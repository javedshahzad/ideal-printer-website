...
class Two_Factor_Email extends Two_Factor_Provider {
	...
	public function get_label() {
		return _x( 'Email', 'Provider Label', 'admin-site-enhancements' );
	}
	...
	public function get_alternative_provider_label() {
		return __( 'Send a code to your email', 'admin-site-enhancements' ) . ' »';
	}
	...
	public function generate_and_email_token( $user ) {
		...
		$subject = wp_strip_all_tags( sprintf( __( 'Your login confirmation code for %s', 'admin-site-enhancements' ), wp_specialchars_decode( get_option( 'blogname' ), ENT_QUOTES ) ) );
		/* translators: %s: token */
		$message = wp_strip_all_tags( sprintf( __( 'Enter %s to log in.', 'admin-site-enhancements' ), $token ) );
	...
	public function authentication_page( $user ) {
		...
		?>
		<p class="two-factor-prompt"><?php esc_html_e( 'A verification code has been sent to the email address associated with your account.', 'admin-site-enhancements' ); ?></p>
		<p>
			<label for="authcode"><?php esc_html_e( 'Verification Code:', 'admin-site-enhancements' ); ?></label>
			...
			<div class="two-factor-prompt-email-ctas">
				<button type="submit" class="button asenha-2fa-action-btn asenha-2fa-verify-btn">
				...
				<div class="two-factor-email-resend">
					<?php $resend_success = isset( $_REQUEST[ self::INPUT_NAME_RESEND_CODE ] ); ?>
					<button type="submit" class="button asenha-2fa-action-btn asenha-2fa-resend-btn" name="<?php echo esc_attr( self::INPUT_NAME_RESEND_CODE ); ?>" value="1" <?php echo $resend_success ? 'data-2fa-show-checkmark="1"' : ''; ?>>
						<span class="asenha-2fa-btn-text"><?php esc_html_e( 'Resend Code', 'admin-site-enhancements' ); ?></span>
						<span class="spinner asenha-2fa-btn-spinner" style="display:none;"></span>
						<span class="asenha-2fa-btn-checkmark dashicons dashicons-yes" style="display:none;"></span>
					</button>
				</div>
		...
		<p>
			...
			echo esc_html(
				...
				/* translators: %s: email address */
					__( 'Authentication codes will be sent to %s.', 'admin-site-enhancements' ),
					$email
				)
			);
			?>
