...
class Settings_Sections_Fields {
	...
	function register_sections_fields() {
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			$field_id = 'two_factor_authentication';
			$field_slug = 'two-factor-authentication';
			$field_title = __( 'Two-Factor Authentication (2FA)', 'admin-site-enhancements' );
			...
			add_settings_field(
				...
				array(
					...
					'field_title'				=> $field_title,
					'field_name'				=> ASENHA_SLUG_U . '[' . $field_id . ']',
					'field_description'			=> __( 'Add an extra verification step during login for some or all user roles.', 'admin-site-enhancements' ),
					'field_options_wrapper'		=> true,
					'field_options_moreless'	=> true,
					'class'						=> 'asenha-toggle security ' . $field_slug,
				)
			...
			$field_id = 'two_factor_available_providers';
			$field_slug = 'two-factor-available-providers';

			$options = array(
				__( 'Authenticator App (TOTP)', 'admin-site-enhancements' )	=> 'totp',
				__( 'Recovery Codes', 'admin-site-enhancements' )			=> 'recovery_codes',
				__( 'Email', 'admin-site-enhancements' )					=> 'email',
			);

			add_settings_field(
				$field_id,
				__( 'Available methods:', 'admin-site-enhancements' ),
				[ $render_field, 'render_checkboxes_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
					...
					'field_name'		=> ASENHA_SLUG_U . '[' . $field_id . '][]',
					'field_options'		=> $options,
					'field_default'		=> array( 'totp', 'recovery_codes', 'email' ),
					'layout'			=> 'horizontal',
					'class'				=> 'asenha-checkboxes margin-top-8 security ' . $field_slug,
				)
			);

			$field_id = 'two_factor_email_token_ttl';
			$field_slug = 'two-factor-email-token-ttl';

			add_settings_field(
				$field_id,
				__( 'Email code validity:', 'admin-site-enhancements' ),
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
			...
			$field_id = 'heading_for_two_factor_enforce_for';
			$field_slug = 'heading-for-two-factor-enforce-for';
			...
			add_settings_field(
				...
				'main-section',
				array(
					'subfields_heading'		=> __( 'Enable and require 2FA only for:', 'admin-site-enhancements' ),
					'class'					=> 'asenha-heading margin-top-m8 margin-bottom-8 security ' . $field_slug,
				)
			);

			$field_id = 'two_factor_enforce_for';
			$field_slug = 'two-factor-enforce-for';
				...
				foreach ( $roles as $role_slug => $role_label ) {
					add_settings_field(
						...
						array(
							...
							'field_name'		=> ASENHA_SLUG_U . '[' . $field_id . '][' . $role_slug . ']',
							'field_label'		=> $role_label,
							'class'				=> 'asenha-checkbox asenha-hide-th asenha-half security ' . $field_slug . ' ' . $role_slug,
						)
					);
				}
			}

			$field_id = 'two_factor_enforce_grace_days';
			$field_slug = 'two-factor-enforce-grace-days';

			add_settings_field(
				$field_id,
				__( 'Grace period:', 'admin-site-enhancements' ),
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
					...
					'field_suffix'			=> '',
					'field_select_options'	=> array(
						__( 'No grace period', 'admin-site-enhancements' )		=> '0',
						__( '1 day', 'admin-site-enhancements' )				=> '1',
						__( '3 days', 'admin-site-enhancements' )				=> '3',
						__( '7 days', 'admin-site-enhancements' )				=> '7',
						__( '14 days', 'admin-site-enhancements' )				=> '14',
						__( '30 days', 'admin-site-enhancements' )				=> '30',
						__( '60 days', 'admin-site-enhancements' )				=> '60',
						__( '90 days', 'admin-site-enhancements' )				=> '90',
					),
					'field_select_default'	=> '14',
					'field_intro'			=> '',
					'field_description'		=> __( 'Users in required roles can keep accessing wp-admin during this period before they are redirected to set up 2FA.', 'admin-site-enhancements' ),
					'class'					=> 'asenha-select extra-narrow margin-top-12 margin-bottom-12 security ' . $field_slug,
					'display_none_on_load'	=> false,
				)
			);

			$field_id = 'two_factor_restrict_api_login_to_app_passwords';
			$field_slug = 'two-factor-restrict-api-login-to-app-passwords';

			add_settings_field(
				$field_id,
				__( 'REST API and XML-RPC access method restriction:', 'admin-site-enhancements' ),
				[ $render_field, 'render_select_subfield' ],
				ASENHA_SLUG,
				'main-section',
				array(
					...
					'field_suffix'			=> '',
					'field_select_options'	=> array(
						__( 'Do not restrict', 'admin-site-enhancements' )									=> '0',
						__( 'Restrict to application passwords (recommended)', 'admin-site-enhancements' )	=> '1',
					),
					'field_select_default'	=> '1',
					'field_intro'			=> '',
					'field_description'		=> '',
					'class'					=> 'asenha-select extra-narrow margin-bottom-12 security ' . $field_slug,
					'display_none_on_load'	=> false,
				)
			);
