...
class Admin_Menu_Organizer {
    ...
    public function render_custom_menu_order( $menu_order ) {
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
            ...
            $custom_submenus_order = ( is_array( json_decode( stripslashes( $custom_submenus_order ), true ) ) ) ? json_decode( stripslashes( $custom_submenus_order ), true ) : array();
        ...
        if ( isset( $_REQUEST ) ) {
            if ( check_ajax_referer( 'save-menu-nonce', 'nonce', false ) ) {
                ...
                if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
                    ...
                    $options['custom_submenus_order'] = isset( $_REQUEST['custom_submenus_order'] ) ? stripslashes( $_REQUEST['custom_submenus_order'] ) : $options['custom_submenus_order'];

                    $options['custom_menu_always_hidden'] = isset( $_REQUEST['custom_menu_always_hidden'] ) ? stripslashes( $_REQUEST['custom_menu_always_hidden'] ) : $options['custom_menu_always_hidden'];

                    $options['custom_submenu_always_hidden'] = isset( $_REQUEST['custom_submenu_always_hidden'] ) ? stripslashes( $_REQUEST['custom_submenu_always_hidden'] ) : $options['custom_submenu_always_hidden'];

                    $options['custom_menu_new_separators'] = isset( $_REQUEST['custom_menu_new_separators'] ) ? $_REQUEST['custom_menu_new_separators'] : $options['custom_menu_new_separators'];
