...
class Change_Login_URL {
    ...
    public function redirect_on_default_login_urls() {
        ...
        if ( isset( $_POST['log'] ) && ! empty( $_POST['log'] ) && isset( $_POST['pwd'] ) && ! empty( $_POST['pwd'] ) ) {
            ...
            if ( in_array( 'paid-memberships-pro/paid-memberships-pro.php', get_option( 'active_plugins', array() ) ) 
            ...
            // When trying to access /wp-admin/admin-post.php, e.g. for accessing the 'admin_post_nopriv_action' hook.
            // https://developer.wordpress.org/reference/hooks/admin_post_nopriv_action/
            // https://github.com/WordPress/wordpress-develop/blob/6.8/src/wp-admin/admin-post.php
