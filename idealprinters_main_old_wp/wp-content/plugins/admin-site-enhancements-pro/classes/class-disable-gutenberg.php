...
class Disable_Gutenberg {
    ...
    public function disable_gutenberg_for_post_types_admin() {
        ...
        if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
            $disable_gutenberg_type = isset( $options['disable_gutenberg_type'] ) ? $options['disable_gutenberg_type'] : 'only-on';
        } else {
        ...
        if ( 'only-on' == $disable_gutenberg_type && in_array( $post_type, $post_types_for_disable_gutenberg ) 
            || 'except-on' == $disable_gutenberg_type && ! in_array( $post_type, $post_types_for_disable_gutenberg )
            || 'all-post-types' == $disable_gutenberg_type
        ) {
    ...
    public function disable_gutenberg_for_post_types_frontend() {
        ...
        if ( 'only-on' == $disable_gutenberg_type && in_array( $post_type, $post_types_for_disable_gutenberg ) 
            ...
            wp_deregister_style( 'classic-theme-styles' ); // classic theme
