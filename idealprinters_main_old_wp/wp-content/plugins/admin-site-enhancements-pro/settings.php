	...
	<div class="wrap asenha">
		...
		<?php if ( bwasenha_fs()->can_use_premium_code__premium_only() ) : ?>
			...
			<div id="asenha-footer" class="asenha-footer" style="display:none;">
				...
				<?php if ( array_key_exists( 'form_builder', $options ) && $options['form_builder'] ) : ?>
				<?php
					$form_builder_forms = Form_Builder_Builder::get_all_forms();
					$entries_export_additional_info_options = array(
				...
				?>
				<h2 id="asenha-export-import-form-builder"><?php echo __( 'Form Builder', 'admin-site-enhancements' ); ?></h2>
				<div class="footer-section export-import">
					<div class="settings-box half texport-settings">
						<h3><?php echo esc_html__( 'Export Forms', 'admin-site-enhancements' ); ?></h3>
						<p><?php echo esc_html__( 'Export forms created with Form Builder as a JSON file to easily import into another site.', 'admin-site-enhancements' ); ?> <?php echo esc_html__( 'Style templates associated with the forms will also be exported.', 'admin-site-enhancements' ); ?></p>
						<form method="post" id="asenha-export-forms-form">
							<p>
								<label for="asenha_forms_export_type">
									<?php echo esc_html__( 'Export type:', 'admin-site-enhancements' ); ?>
								</label>
								<select name="asenha_forms_export_type" id="asenha_forms_export_type" class="asenha-forms-export-type">
									<option value="all"><?php echo esc_html__( 'All forms', 'admin-site-enhancements' ); ?></option>
									<option value="manual"><?php echo esc_html__( 'Manual selection', 'admin-site-enhancements' ); ?></option>
								</select>
							</p>
							<div id="asenha-forms-export-options" class="asenha-forms-export-options" style="display:none;">
								<div id="asenha-forms-export-loading" class="asenha-forms-export-loading" style="display:none;">
									<span class="spinner is-active"></span>
									<span><?php echo esc_html__( 'Loading...', 'admin-site-enhancements' ); ?></span>
								</div>
								<div id="asenha-forms-export-content" class="asenha-forms-export-content"></div>
							</div>
							<p><input type="hidden" name="asenha_export_action" value="export_forms" /></p>
							<input type="hidden" name="asenha_selected_form_ids" id="asenha_selected_form_ids" value="" />
							<p>
								<?php wp_nonce_field('asenha_export_nonce', 'asenha_export_nonce'); ?>
								<?php wp_nonce_field('asenha_forms_export_ajax_nonce_' . get_current_user_id(), 'asenha_forms_export_ajax_nonce'); ?>
								<?php submit_button( __( 'Export Forms', 'admin-site-enhancements' ), 'secondary', 'submit', false); ?>
							</p>
						</form>
					</div>
					<div class="settings-box half import-settings">
						<h3><?php echo esc_html__( 'Import Forms', 'admin-site-enhancements' ); ?></h3>
						<p><?php echo esc_html__( 'Import forms you\'ve exported from another site as a JSON file.', 'admin-site-enhancements' ); ?> <?php echo esc_html__( 'Style templates associated with those forms will also be imported.', 'admin-site-enhancements' ); ?></p>
						<form enctype="multipart/form-data" id="import-forms-upload-form" method="post" class="wp-upload-form" action="<?php echo esc_url( wp_nonce_url( 'tools.php?page=admin-site-enhancements', 'asenha-import-forms-nonce' ) ); ?>">
							<p>
								<input type="file" id="imported-forms-upload" name="imported-forms" accept=".json" />
								<input type="hidden" name="action" value="save" />
								<input type="hidden" name="max_file_size" value="<?php echo esc_html( wp_max_upload_size() ); ?>" />
								<?php wp_nonce_field('asenha-import-forms-nonce'); ?>
							</p>
							<?php submit_button( __( 'Import Forms', 'admin-site-enhancements' ), 'button', 'asenha-upload-json-file'); ?>
						</form>
					</div>
				</div>
				<div class="footer-section export-import" id="asenha-export-import-style-templates">
					<div class="settings-box half texport-settings">
						<h3><?php echo esc_html__( 'Export Style Templates', 'admin-site-enhancements' ); ?></h3>
						<p><?php echo esc_html__( 'Export style templates created with Form Builder as a JSON file to easily import into another site.', 'admin-site-enhancements' ); ?></p>
						<form method="post" id="asenha-export-style-templates-form">
							<p>
								<label for="asenha_style_templates_export_type">
									<?php echo esc_html__( 'Export type:', 'admin-site-enhancements' ); ?>
								</label>
								<select name="asenha_style_templates_export_type" id="asenha_style_templates_export_type" class="asenha-style-templates-export-type">
									<option value="all"><?php echo esc_html__( 'All style templates', 'admin-site-enhancements' ); ?></option>
									<option value="manual"><?php echo esc_html__( 'Manual selection', 'admin-site-enhancements' ); ?></option>
								</select>
							</p>
							<div id="asenha-style-templates-export-options" class="asenha-style-templates-export-options" style="display:none;">
								<div id="asenha-style-templates-export-loading" class="asenha-style-templates-export-loading" style="display:none;">
									<span class="spinner is-active"></span>
									<span><?php echo esc_html__( 'Loading...', 'admin-site-enhancements' ); ?></span>
								</div>
								<div id="asenha-style-templates-export-content" class="asenha-style-templates-export-content"></div>
							</div>
							<p><input type="hidden" name="asenha_export_action" value="export_style_templates" /></p>
							<input type="hidden" name="asenha_selected_style_template_ids" id="asenha_selected_style_template_ids" value="" />
							<p>
								<?php wp_nonce_field('asenha_export_nonce', 'asenha_export_nonce'); ?>
								<?php wp_nonce_field('asenha_style_templates_export_ajax_nonce_' . get_current_user_id(), 'asenha_style_templates_export_ajax_nonce'); ?>
								<?php submit_button( __( 'Export Style Templates', 'admin-site-enhancements' ), 'secondary', 'submit', false); ?>
							</p>
						</form>
					</div>
					<div class="settings-box half import-settings">
						<h3><?php echo esc_html__( 'Import Style Templates', 'admin-site-enhancements' ); ?></h3>
						<p><?php echo esc_html__( 'Import style templates you\'ve exported from another site as a JSON file.', 'admin-site-enhancements' ); ?></p>
						<form enctype="multipart/form-data" id="import-style-templates-upload-form" method="post" class="wp-upload-form" action="<?php echo esc_url( wp_nonce_url( 'tools.php?page=admin-site-enhancements', 'asenha-import-style-templates-nonce' ) ); ?>">
							<p>
								<input type="file" id="imported-style-templates-upload" name="imported-style-templates" accept=".json" />
								<input type="hidden" name="action" value="save" />
								<input type="hidden" name="max_file_size" value="<?php echo esc_html( wp_max_upload_size() ); ?>" />
								<?php wp_nonce_field('asenha-import-style-templates-nonce'); ?>
							</p>
							<?php submit_button( __( 'Import Style Templates', 'admin-site-enhancements' ), 'button', 'asenha-upload-json-file'); ?>
						</form>
					</div>
				</div>
				<div class="footer-section export-import" id="asenha-export-import-entries">
					<div class="settings-box">
						<h3><?php echo esc_html__( 'Export Entries', 'admin-site-enhancements' ); ?></h3>
						<p><?php echo esc_html__( 'Export entries submitted via Form Builder in CSV, Excel (.xlsx), or JSON format.', 'admin-site-enhancements' ); ?></p>
						<form method="post" id="asenha-export-entries-form">
							<p>
								<label for="asenha_entries_export_form_id">
									<?php echo esc_html__( 'Form:', 'admin-site-enhancements' ); ?>
								</label>
								<select name="asenha_entries_export_form_id" id="asenha_entries_export_form_id" class="asenha-entries-export-form">
									<option value=""><?php echo esc_html__( 'Select a form', 'admin-site-enhancements' ); ?></option>
									<?php foreach ( $form_builder_forms as $form_builder_form ) : ?>
										<option value="<?php echo esc_attr( $form_builder_form->id ); ?>"><?php echo esc_html( '' === $form_builder_form->name ? __( '(Untitled form)', 'admin-site-enhancements' ) : $form_builder_form->name ); ?></option>
									<?php endforeach; ?>
								</select>
							</p>
							<div id="asenha-entries-export-selection-panel" class="asenha-entries-export-options" style="display:none;">
								<div id="asenha-entries-export-fields-loading" class="asenha-entries-export-loading" style="display:none;">
									<span class="spinner is-active"></span>
									<span><?php echo esc_html__( 'Loading...', 'admin-site-enhancements' ); ?></span>
								</div>
								<div id="asenha-entries-export-fields-content" class="asenha-entries-export-content"></div>
								<p class="asenha-entries-export-section-heading">
									<strong><?php echo esc_html__( 'Additional information:', 'admin-site-enhancements' ); ?></strong>
								</p>
								<div id="asenha-entries-export-additional-info-options" class="asenha-entries-export-additional-info-options">
									<div class="asenha-entries-additional-info-list">
										<?php foreach ( $entries_export_additional_info_options as $additional_info_key => $additional_info_label ) : ?>
											<label>
												<input type="checkbox" class="asenha-entry-additional-info-checkbox" value="<?php echo esc_attr( $additional_info_key ); ?>" checked />
												<?php echo esc_html( $additional_info_label ); ?>
											</label>
										<?php endforeach; ?>
									</div>
								</div>
							</div>
							<div class="asenha-entries-export-date-range">
								<p>
									<label for="asenha_entries_export_date_from">
										<?php echo esc_html__( 'Date range:', 'admin-site-enhancements' ); ?>
									</label>
									<input type="text" id="asenha_entries_export_date_range_display" value="" placeholder="<?php echo esc_attr__( 'Defaults to all dates (all entries). Click to narrow the range.', 'admin-site-enhancements' ); ?>" readonly />
									<input type="hidden" name="asenha_entries_export_date_from" id="asenha_entries_export_date_from" value="" />
									<input type="hidden" name="asenha_entries_export_date_to" id="asenha_entries_export_date_to" value="" />
								</p>
							</div>
							<p>
								<label for="asenha_entries_export_format">
									<?php echo esc_html__( 'Export format:', 'admin-site-enhancements' ); ?>
								</label>
								<select name="asenha_entries_export_format" id="asenha_entries_export_format" class="asenha-entries-export-format">
									<option value="csv"><?php echo esc_html__( 'CSV', 'admin-site-enhancements' ); ?></option>
									<option value="xlsx"><?php echo esc_html__( 'Excel (.xlsx)', 'admin-site-enhancements' ); ?></option>
									<option value="json"><?php echo esc_html__( 'JSON', 'admin-site-enhancements' ); ?></option>
								</select>
							</p>
							<p><input type="hidden" name="asenha_export_action" value="export_entries" /></p>
							<input type="hidden" name="asenha_selected_entry_field_ids" id="asenha_selected_entry_field_ids" value="" />
							<input type="hidden" name="asenha_selected_entry_additional_info" id="asenha_selected_entry_additional_info" value="" />
							<p>
								<?php wp_nonce_field( 'asenha_export_nonce', 'asenha_export_nonce' ); ?>
								<?php wp_nonce_field( 'asenha_entries_export_fields_ajax_nonce_' . get_current_user_id(), 'asenha_entries_export_fields_ajax_nonce' ); ?>
								<?php submit_button( __( 'Export Entries', 'admin-site-enhancements' ), 'secondary', 'submit', false ); ?>
							</p>
						</form>
					</div>
				</div>
...
function asenha_admin_scripts( $hook_suffix ) {
	...
	if ( is_asenha() ) {
		...
		$admin_page_script_dependencies = array( 'asenha-jsticky', 'asenha-jbox', 'asenha-js-cookie', 'asenha-codemirror-htmlmixed-mode', 'asenha-codemirror-xml-mode', 'asenha-codemirror-javascript-mode', 'asenha-codemirror-css-mode', 'asenha-codemirror-markdown-mode', 'asenha-datatables', 'wp-color-picker', 'wp-mediaelement', 'wp-tinymce-root', 'wp-tinymce' );

		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			if ( array_key_exists( 'form_builder', $options ) && $options['form_builder'] ) {
				wp_enqueue_style( 'asenha-flatpickr-default', ASENHA_URL . 'includes/premium/custom-content/cfgroup/assets/css/flatpickr/flatpickr.min.css', array(), ASENHA_VERSION );
				wp_enqueue_script( 'asenha-flatpickr', ASENHA_URL . 'includes/premium/custom-content/cfgroup/assets/js/flatpickr/flatpickr.min.js', array( 'jquery' ), ASENHA_VERSION, false );
				$admin_page_script_dependencies[] = 'asenha-flatpickr';
			}
		}
		...
		wp_enqueue_script( 'asenha-admin-page', ASENHA_URL . 'assets/js/admin-page.js', $admin_page_script_dependencies, ASENHA_VERSION, false );
		...
		if ( bwasenha_fs()->can_use_premium_code__premium_only() ) {
			...
			$jsvars['formsExportNoFormsInfo'] = __( 'No forms found.', 'admin-site-enhancements' );
			$jsvars['formsExportSelectFormsLabel'] = __( 'Select forms to export:', 'admin-site-enhancements' );
			$jsvars['formsExportEditLabel'] = __( 'Edit', 'admin-site-enhancements' );
			$jsvars['formsExportNoFormsSelectedAlert'] = __( 'Please select at least one form.', 'admin-site-enhancements' );
			$jsvars['styleTemplatesExportNoTemplatesInfo'] = __( 'No style templates found.', 'admin-site-enhancements' );
			$jsvars['styleTemplatesExportSelectTemplatesLabel'] = __( 'Select style templates to export:', 'admin-site-enhancements' );
			$jsvars['styleTemplatesExportEditLabel'] = __( 'Edit', 'admin-site-enhancements' );
			$jsvars['styleTemplatesExportNoTemplatesSelectedAlert'] = __( 'Please select at least one style template.', 'admin-site-enhancements' );
			$jsvars['entriesExportNoFieldsInfo'] = __( 'No fields found for the selected form.', 'admin-site-enhancements' );
			$jsvars['entriesExportSelectFieldsLabel'] = __( 'Select fields to export:', 'admin-site-enhancements' );
			$jsvars['entriesExportSelectFormAlert'] = __( 'Please select a form to export entries from.', 'admin-site-enhancements' );
			$jsvars['entriesExportNoFieldsSelectedAlert'] = __( 'Please select at least one field to export.', 'admin-site-enhancements' );
			$jsvars['entriesExportInvalidDateRangeAlert'] = __( 'The start date cannot be later than the end date.', 'admin-site-enhancements' );
			$jsvars['entriesExportDateFormatPhp'] = get_option( 'date_format', 'F j, Y' );
		}
