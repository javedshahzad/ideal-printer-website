    ...
    async recordItemAction(item) {
        ...
        */
        ...
        if (trackable.isDefined()) {
            ...
            const serializedUpdates = js_cookie__WEBPACK_IMPORTED_MODULE_4__["default"].get(cookieName);
            ...
            js_cookie__WEBPACK_IMPORTED_MODULE_4__["default"].set(cookieName, JSON.stringify(pendingUpdates), { sameSite: 'Lax', path: this.cookiePath });
        }
...
class DashboardCrawlerDb {
    constructor(ajaxActions, preloadedRecords) {
        ...
        this.throttledFetchCrawlRecords = lodash_es__WEBPACK_IMPORTED_MODULE_2__["default"](lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"](() => this.fetchPendingCrawlRecords(), 2000, { leading: true, trailing: true }), 200, { leading: false, trailing: true });
        this.pendingCrawlRecordSaves = new Set();
        this.throttledSaveCrawlRecords = lodash_es__WEBPACK_IMPORTED_MODULE_3__["default"](() => this.storePendingCrawlRecords(), 2000, { leading: true, trailing: true });
        if (preloadedRecords) {
...
/* harmony export */   EntityItem: () => (/* binding */ EntityItem),
...
class EntityItem extends SearchableItem {
    constructor(props) {
        super(props);
...
/* harmony import */ var _scanner__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scanner */ "./extras/modules/quick-search/scanner.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./extras/modules/quick-search/utils.ts");
/* harmony import */ var _items__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./items */ "./extras/modules/quick-search/items.ts");
/* harmony import */ var _crawler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./crawler */ "./extras/modules/quick-search/crawler.ts");
/* harmony import */ var _app_geometry__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./app-geometry */ "./extras/modules/quick-search/app-geometry.ts");
/* harmony import */ var _db__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./db */ "./extras/modules/quick-search/db.ts");
...
(function (AmeQuickSearchTool) {
    ...
    const logger = loglevel__WEBPACK_IMPORTED_MODULE_1___default().getLogger('AmeQuickSearchTool');
    class SearchResult {
        constructor(item, score, findMenuTitle = () => null, findEntityIconClass = () => null) {
            this.findMenuTitle = findMenuTitle;
            this.iconClass = 'ame-fa ame-fa-puzzle-piece';
            this.itemClass = '';
            this.item = item;
            this.score = score;
            if (item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.DashboardItem) {
            ...
            else if (item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.AdminMenuItem) {
                this.iconClass = 'ame-fa ame-fa-bars';
            }
            else if (item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.EntityItem) {
            ...
            if (item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.LoadingPlaceholderItem) {
        ...
        get metaLabel() {
            ...
            if (this.item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.DashboardItem) {
    ...
    class ResultPool {
        constructor(findMenuTitle, findEntityIconClass) {
            this.findMenuTitle = findMenuTitle;
            this.findEntityIconClass = findEntityIconClass;
            this.resultCache = new _utils__WEBPACK_IMPORTED_MODULE_3__.LRUCache(200);
        }
    ...
    class SearchEngine {
        constructor(initialItems, initialResultsCallback, fullResultsCallback, findMenuTitle, findEntityIconClass, relativeMenuUrls, searchAction, cacheCapacity = 2000) {
            ...
            this.queryResponseCache = new _utils__WEBPACK_IMPORTED_MODULE_3__.LRUCache(20);
            this.activeServerQueries = ko.observable(0);
            this.throttledServerQuery = lodash_es__WEBPACK_IMPORTED_MODULE_0__["default"](this.sendPendingServerQuery, 1000, { leading: true, trailing: true });
            this.itemCache = new _utils__WEBPACK_IMPORTED_MODULE_3__.LRUCache(cacheCapacity);
        ...
        sendPendingServerQuery() {
            ...
            this.searchAction.ajax({
                ...
                for (const itemData of response.data.items) {
                    const item = (0,_items__WEBPACK_IMPORTED_MODULE_4__.unserializeItem)(itemData);
                    if (item) {
    ...
    function completeNavigation(targetSelector) {
        ...
        //Find the new target.
        let $target = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.queryAdvancedSelector)(targetSelector);
        if ($target.length < 1) {
            return;
        }
    ...
    class QuickSearchApp {
        constructor(deps) {
            ...
            this.crawlerUrlBlacklist = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.lazy)(() => new _crawler__WEBPACK_IMPORTED_MODULE_5__.CrawlerUrlBlacklist([
                ...
                new RegExp((0,_utils__WEBPACK_IMPORTED_MODULE_3__.escapeRegExp)(_scanner__WEBPACK_IMPORTED_MODULE_2__.userIdQueryPlaceholder)),
            ...
            this.geometryStore = new _app_geometry__WEBPACK_IMPORTED_MODULE_6__.PanelGeometryStore(scriptData.siteCookiePath);
            this.recencyTracking = scriptData.recencyTracking;
            this.ajaxActions = AjawV2.createStrictActionMap(scriptData.ajaxActions, ['search', 'updateIndex', 'setCrawlerEnabled', 'getCrawlRecords', 'setCrawlRecords']);
            this.requestNavigation = (url, targetSelector, openInNewTab = false) => {
            ...
            this.searchResults.push(new SearchResult(new _items__WEBPACK_IMPORTED_MODULE_4__.LoadingPlaceholderItem(), 1));
            ...
            adminMenuParserResult.items.forEach((item) => {
                if (item instanceof _items__WEBPACK_IMPORTED_MODULE_4__.AdminMenuItem) {
            ...
            const findEntityIconClass = (item) => {
            ...
            this.searchEngine = new SearchEngine(initialItems, this.updateInitialResults, this.updateFullResults, findItemByRelativeUrl, findEntityIconClass, this.presentFilteredMenuUrls, this.ajaxActions.search);
            ...
            this.normalizeUrlForCrawling = (url, baseUrl) => {
                return (0,_utils__WEBPACK_IMPORTED_MODULE_3__.normalizeUrl)(url, baseUrl, this.removableQueryArgs, true).toString();
            };
            ...
            if (this.recencyTracking === 'enableOnFirstUse') {
                ...
                searchSubscription = this.searchInput.subscribe((query) => {
                    if (query !== '') {
                        ...
                        js_cookie__WEBPACK_IMPORTED_MODULE_8__["default"].set('ame-qs-recency-tracking', 'enabled', {
                            expires: 30,
                            sameSite: 'Lax',
        ...
        performSelectionAction(newTab = false) {
            const selection = this.selectedResult();
            if (selection) {
        ...
        handleResultClick(result, newTab = false) {
            this.selectedResult(result);
            this.performSelectionAction(newTab);
        }
        replaceUserPlaceholderInUrl(url) {
            if (this.currentUserId && url.includes(_scanner__WEBPACK_IMPORTED_MODULE_2__.userIdQueryPlaceholder)) {
                return url.replace(_scanner__WEBPACK_IMPORTED_MODULE_2__.userIdQueryPlaceholder, this.currentUserId.toString());
            }
            return url;
        }
        parseAdminMenuItems() {
        ...
        async _updateDashboardItemIndexInternal(menuItems, bypassSchedulingChecks = false) {
            ...
            if (js_cookie__WEBPACK_IMPORTED_MODULE_8__["default"].get(crawlerRunningCookie)) {
                return Either.left(new Error('Skipping index update because another crawl is already running.'));
            }
            const expirationInMinutes = 45;
            js_cookie__WEBPACK_IMPORTED_MODULE_8__["default"].set(crawlerRunningCookie, '1', {
                sameSite: 'Lax',
                expires: new Date(Date.now() + expirationInMinutes * 60 * 1000)
            });
            this.crawler(null);
            const blacklist = this.crawlerUrlBlacklist();
            const crawlerDb = new _db__WEBPACK_IMPORTED_MODULE_7__.DashboardCrawlerDb(this.ajaxActions, this.crawlerConfig.preloadedRecords);
            ...
            for (const item of maybeCrawl) {
                ...
                if (reason.isRight()) {
                    const request = new _crawler__WEBPACK_IMPORTED_MODULE_5__.CrawlRequest(menuUrl, this.normalizeUrlForCrawling(item.getUrl(), window.location.href), this.adminUrl, item.getLocation(), 0, reason.value, this.getMenuComponent(menuUrl));
            ...
            if (potentialRequests.length < 1) {
                js_cookie__WEBPACK_IMPORTED_MODULE_8__["default"].remove(crawlerRunningCookie, { sameSite: 'Lax' });
                return Either.right(0);
            }
            const crawler = new _crawler__WEBPACK_IMPORTED_MODULE_5__.Crawler(this.adminUrl, this.currentUserId, this.removableQueryArgs, this.normalizeUrlForCrawling, blacklist);
        ...
        couldCrawlMenuItem(menuItem, blacklist) {
            ...
            if (!(0,_utils__WEBPACK_IMPORTED_MODULE_3__.isAdminPageUrl)(fullUrl, this.adminUrl)) {
        ...
        storeFoundItemsForMenu(menuUrl, items) {
            ...
            this.dashboardIndexUpdateTimeout = window.setTimeout(() => {
                ...
                this.ajaxActions.updateIndex.post({ updates: JSON.stringify(updates) }, (response) => {
        ...
        debugScanCurrentPage() {
            ...
            const testScanner = new _scanner__WEBPACK_IMPORTED_MODULE_2__.PageScanner(_scanner__WEBPACK_IMPORTED_MODULE_2__.builtinScanners);
    ...
    class AppDependencyFactory {
        constructor(scriptData) {
            ...
            this.adminMenuParserResult = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.lazy)(() => (0,_scanner__WEBPACK_IMPORTED_MODULE_2__.parseAdminMenuItems)(jQuery('body'), this.adminUrl, this.scriptData.removableQueryArgs));
            this.itemUsageTracker = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.lazy)(() => {
                ...
                return new _db__WEBPACK_IMPORTED_MODULE_7__.ItemUsageTracker(sitePath, 200, this.scriptData.adminCookiePath);
            });
            this.recordCurrentVisit = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.lazy)(() => {
                const promises = [];
                ...
                const currentPageUrl = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.getRelativeAdminPageUrl)(window.location.href, this.adminUrl, '', this.scriptData.removableQueryArgs);
                if (currentPageUrl) {
                    promises.push(tracker.recordPageVisit(currentPageUrl));
                }
                return Promise.all(promises);
            });
            this.pageStats = (0,_utils__WEBPACK_IMPORTED_MODULE_3__.lazy)(() => {
...
function parseAdminMenuItems($root, adminUrl, removableQueryArgs = []) {
    ...
    $root.find('#adminmenu li > a').each((_, element) => {
        ...
        if (url) {
            url = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.normalizeUrl)(url, window.location.href, [], false).toString();
        }
...
function normalizeUrl(inputUrl, baseUrl = '', removableQueryParams = [], removeHash = true) {
